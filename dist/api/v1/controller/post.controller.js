        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return _database.Post.paginate({}, options);
            ...
            case 10:
              _context.next = 12;
              return _database.Post.find().populate('category').sort({
                created_at: -1
              }).exec();
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              id = req.params.id;
              _context2.next = 4;
              return _database.Post.findById(id).populate('category').exec();
      ...
      return _regenerator.default.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 4:
              post = _context3.sent;
              return _context3.abrupt("return", res.status(201).json(post));

            case 8:
              _context3.prev = 8;
              _context3.t0 = _context3["catch"](0);
              return _context3.abrupt("return", (0, _utilities.handleAPIError)(_context3.t0.status || 500, _context3.t0.message || 'Some error occurred while saving the Post!', next));
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 13:
              ...
              return _context4.abrupt("return", (0, _utilities.handleAPIError)(_context4.t0.status || 500, _context4.t0.message || "Some error occurred while deleting the Post with id: ".concat(id, "!"), next));
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 11:
              ...
              return _context5.abrupt("return", (0, _utilities.handleAPIError)(_context5.t0.status || 500, _context5.t0.message || "Some error occurred while deleting the Post with id: ".concat(id, "!"), next));
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 7;
              return _database.Post.findByIdAndUpdate({
                _id: id
              }, {
            ...
            case 21:
              ...
              return _context6.abrupt("return", (0, _utilities.handleAPIError)(_context6.t0.status || 500, _context6.t0.message || "Some error occurred while deleting the Post with id: ".concat(id, "!"), next));
